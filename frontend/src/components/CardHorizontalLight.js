  ...
  return (
    ...
    <div className="card bg-light mb-3">
      <div className="card-body">
        ...
        <p className="card-text m-0 text-muted">Category: {props?.value?.category?.name??props?.value?.category[0]?.name??"-"}</p>
        <p className="card-text m-0 text-muted">Brand: {props.value.brand.name}</p>
